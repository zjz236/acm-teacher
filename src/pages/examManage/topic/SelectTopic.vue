<template>
	<div class="select-topic">
		<el-card header="选择题" v-loading="tableLoading">
			<div class="topic-select">
				<el-button style="margin-bottom: 20px;" @click="selectVisible = true">从题库选题</el-button>
		...
		<el-dialog :visible.sync="selectVisible" title="从题库选题">
		...
		<select-modify @save="modifyExamTopic" editable :loading="modifyLoading" :data="formData"
								v-model="modifyVisible"></select-modify>
	</div>
</template>
