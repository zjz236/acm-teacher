    ...
    export default {
        ...
        methods:{
            ...
            addExamSelect(data){
                ...
                ajaxService.addExamSelect({public:0,examId:this.examId,data}).then(res=>{
                    if (res.code==1){
                        this.getUserSelect()
                        this.getList()
                    }
            ...
            getUserSelect(){
                this.load=true
                ajaxService.getUserSelect({examId:this.examId,section:this.search,limit:this.pageSize,page:this.currentPage-1,public:0}).then(res=>{
                    if (res.code==1){
